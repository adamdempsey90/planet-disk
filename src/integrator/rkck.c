...
static const double a[6] = {0,0.2, .3, .6, 1., .875};
static const double b1 = .2;
static const double b2[5]	= {3./40,9./40,0,0,0};
static const double b3[5]	= {.3,-.9,1.2,0,0};
static const double b4[5]	= {-11./54,2.5,-70./27,35./27,0};
static const double b5[5]	= {1631./55296,175./512,575./13824,44275./110592,253./4096};	

static double c[6] = {2825./27648,0,18575./48384,13525./55296,277./14366,.25};
